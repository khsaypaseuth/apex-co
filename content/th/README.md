# Thai (th) content — not yet active
...
## How to activate Thai

1. Add `'th'` to `activeLocales` in `lib/i18n-config.ts`.
2. Create `dictionaries/th.json` (copy `dictionaries/en.json` and translate
