---
title: "Tax Obligations for Companies"
summary: "A plain-language overview of the main taxes and filing duties that registered companies in the Lao PDR are commonly expected to meet."
...
- Every company registered in Laos, including companies that are dormant or not yet trading — filing obligations commonly continue even with no activity
- Foreign-invested companies, which follow the same core tax framework as local companies
- Branches and representative offices, whose obligations differ by form and permitted activities
- Company directors and accountants, who are responsible for filings being accurate and on time

## Key obligations

The exact set of obligations depends on the company's size, activity, and VAT status, but companies are commonly expected to:
...
- Assuming that no revenue means no filings — missed nil filings commonly accumulate penalties quietly
- Registering the company but delaying tax registration, which can block invoicing and banking
- Mixing personal and company funds, making the accounts impossible to reconcile at year end
- Forgetting withholding obligations on payments to individuals or foreign suppliers
- Leaving the annual finalisation to the deadline without reconciled books, and discovering gaps too late to fix cleanly
