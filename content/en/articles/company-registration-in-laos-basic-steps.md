...
- Lao nationals forming a company for a local business
- Foreign investors setting up a wholly or partly foreign-owned company
- Existing foreign companies establishing a branch or representative office

Foreign-owned registrations often involve additional checks, because some sectors are conditional or restricted for foreign investment. Confirming the status of your intended activity is the sensible first step.
...
| Document | Notes |
| --- | --- |
| Passport or ID of shareholders and directors | Copies are usually required for each person named |
| Articles of association | The company's constitutional document |
| Registered address evidence | Commonly a lease agreement or ownership document |
| Activity description | Should match the registry's activity classifications |
| Capital information | How much is being contributed and by whom |

Authorities may request additional documents depending on the sector, the nationality of shareholders, and the structure chosen. Requirements change over time, so the current list should be confirmed before filing.
