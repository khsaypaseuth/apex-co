...
export function GuideCard({
  ...
  return (
    <Link
      href={href}
      className="group flex h-full flex-col overflow-hidden rounded-sm border border-navy-950/10 border-t-2 border-t-gold-500 bg-white transition-colors hover:border-gold-500 focus-visible:outline-2 focus-visible:outline-gold-500"
    >
      {image && (
