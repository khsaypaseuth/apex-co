...
All images sourced from Pexels under the [Pexels License](https://www.pexels.com/license/) (free for commercial use, no attribution legally required — attributed here as project policy). Downloaded 2026-07-10 (hero/, articles/, and the first nine sections/ images) and 2026-07-11 (categories/ and the four newest sections/ images) via the Pexels CDN (`images.pexels.com`), resized to hero ≤ 2400px / cards ≤ 1200px / banners ≤ 1600px, all files ≤ 600KB. Where a portrait original was cropped to landscape, the crop was done by the Pexels CDN (`fit=crop`) and is noted in the description.
...
| File | Source page | Photographer | License | Description |
|---|---|---|---|---|
| `sections/contract-signing.jpg` | https://www.pexels.com/photo/a-person-about-to-sign-the-document-8441783/ | Kampus Production | Pexels License | Close-up of hands signing a business document |
| `sections/meeting-documents.jpg` | https://www.pexels.com/photo/person-holding-paper-and-pencil-7869003/ | Pavel Danilyuk | Pexels License | Team analyzing business reports and charts during a meeting |
| `sections/handshake-over-table.jpg` | https://www.pexels.com/photo/unrecognizable-hands-handshaking-over-table-9870223/ | Ron Lach | Pexels License | Unrecognizable hands shaking over documents on a table — agreement/consultation |
| `sections/modern-office-interior.jpg` | https://www.pexels.com/photo/modern-design-of-a-business-office-7534226/ | Artbovich | Pexels License | Sleek modern office interior, minimalist design, earthy tones, natural light |
| `sections/calm-workspace.jpg` | https://www.pexels.com/photo/black-laptop-computer-on-table-3747070/ | Polina Zimmerman | Pexels License | Minimalist workspace — laptop on wooden desk in front of large windows |
| `sections/stone-columns-corridor.jpg` | https://www.pexels.com/photo/elegant-classical-architecture-with-stone-columns-30297627/ | Sabine Otten | Pexels License | Classic stone columns in a sunlit historical building corridor (government-building feel) |
| `sections/golden-buddha-temple-detail.jpg` | https://www.pexels.com/photo/buddha-golden-figure-17616587/ | Ehsan Haque (itsehsanh) | Pexels License | Ornate golden Buddha statues at a temple in Vientiane, Laos — cultural detail |
| `sections/accounting-calculator-report.jpg` | https://www.pexels.com/photo/financial-analysis-with-calculator-and-report-33175667/ | Bia Limova | Pexels License | Desk with calculator, financial report, and pen — accounting/tax theme |
| `sections/passport-stamps.jpg` | https://www.pexels.com/photo/person-holding-an-opened-passport-4922086/ | Ekaterina Belinskaya | Pexels License | Hand holding an open passport with visa stamps — immigration theme |
| `sections/team-office-collaboration.jpg` | https://www.pexels.com/photo/people-working-in-front-of-the-computer-3184357/ | fauxels | Pexels License | Team working together at shared desks in a bright modern office — about-page collaboration theme |
...
| File | Source page | Photographer | License | Description |
|---|---|---|---|---|
| `articles/business-signing-desk.jpg` | https://www.pexels.com/photo/a-person-signing-contract-documents-6814526/ | cottonbro studio | Pexels License | Person in business attire signing a document at a wooden office table |
| `articles/tax-calculator-documents.jpg` | https://www.pexels.com/photo/documents-17065743/ | Jakub Zerdzicki | Pexels License | Calculator with glasses and folders on an office desk — finance/tax theme |
| `articles/travel-documents-passports.jpg` | https://www.pexels.com/photo/polish-passports-and-travel-documents-on-a-table-33497885/ | Jakub Zerdzicki | Pexels License | Passports and travel tickets on a table — travel documents theme |
| `articles/family-walking-sidewalk.jpg` | https://www.pexels.com/photo/back-view-of-a-family-holding-each-other-s-hands-while-walking-on-the-sidewalk-8576089/ | PNW Production | Pexels License | Back view of a family holding hands walking on a sunny sidewalk (no faces) |
...
One editorial thumbnail per Knowledge Center article category, for card thumbnails. All 1200px wide, landscape.
...
- No image implies a real client identity; faces are absent or incidental in all section/article images.
- `hero/riverside-city-dusk-aerial.jpg` carries no location tag on its source page — use generic alt text ("Southeast Asian riverside city at dusk"), not "Vientiane".
- `sections/contract-signing.jpg` contains an embedded EXIF copyright string from the photographer; usage remains governed by the Pexels License under which it is distributed.
- Location-confirmed Laos images: `hero/mekong-river-sunset-luang-prabang.jpg`, `hero/mekong-mountains-dusk-bokeo.jpg`, `sections/golden-buddha-temple-detail.jpg`, `sections/luang-prabang-street-corner.jpg`, `articles/mekong-boats-luang-prabang.jpg`. All other imagery is location-generic or non-Lao (Bali, Vietnam, etc. as flagged per row) and must not be captioned as Laos/Vientiane.
- `categories/compliance-checklists-planner.jpg` uses the legacy CDN filename `pen-calendar-to-do-checklist.jpg` (pre-2016 upload); the standard `pexels-photo-<id>.jpeg` URL is not served for this ID.
